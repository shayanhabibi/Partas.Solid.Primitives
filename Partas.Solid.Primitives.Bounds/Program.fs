...
module BoundsSpec =
    ...
    module Spec =
        [<Literal>]
        let path = "@solid-primitives/bounds"
...
type Bounds =
    ...
    static member createElementBounds
        (target: #HTMLElement, ?trackScroll: bool, ?trackMutation: bool, ?trackResize: bool)
        : ElementBounds =
        jsNative
    ...
    [<ImportMember(Spec.path); ParamObject(1)>]
    static member createElementBounds
        (target: Accessor<#HTMLElement>, ?trackScroll: bool, ?trackMutation: bool, ?trackResize: bool)
        : ElementBounds =
        jsNative
